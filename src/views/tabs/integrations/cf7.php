...
$gtmkit_cf7_is_inactive = ! is_plugin_active( 'contact-form-7/wp-contact-form-7.php' );
?>
	...
	$form->setting_row(
		...
		[
			'attributes' => [
				'disabled' => $gtmkit_cf7_is_inactive,
			],
		],
	...
	$gtmkit_field_data['legend']      = __( 'Where do you want load the JavaScript?', 'gtm-kit' );
