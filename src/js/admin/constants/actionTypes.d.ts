...
export declare const STOP_SUPPORT_SYNC_BEFORE: 'STOP_SUPPORT_SYNC_BEFORE';
export declare const STOP_SUPPORT_SYNC: 'STOP_SUPPORT_SYNC';
...
export type ActionType =
	...
	| typeof STOP_SUPPORT_SYNC_BEFORE
	| typeof STOP_SUPPORT_SYNC
